...
```eos
!
username arista privilege 15 role network-admin secret sha512 $6$workshop$T13brFPEnwqJUNL55Lg3ijW4ar6Pr3wPw68e/kbYyvQNg23L8jfJhruq9qXL.5VHRrL5GWly9P5/bcbaaRDHF/
```
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | MLAG_PEER_s1-leaf1_Ethernet1 | *trunk | *2-4094 | *- | *['MLAG'] | 1 |
| Ethernet2 | S1-SPINE1_Ethernet3 | *trunk | *none | *- | *- | 2 |
| Ethernet3 | S1-SPINE2_Ethernet3 | *trunk | *none | *- | *- | 2 |
| Ethernet6 | MLAG_PEER_s1-leaf1_Ethernet6 | *trunk | *2-4094 | *- | *['MLAG'] | 1 |
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel1 | MLAG_PEER_s1-leaf1_Po1 | switched | trunk | 2-4094 | - | ['MLAG'] | - | - | - | - |
